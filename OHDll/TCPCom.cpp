...
using namespace TCP;
 ...
 void TCPCom::connect(boost::asio::ip::tcp::resolver::iterator endpoint_iter)
{
 ...
 void TCPCom::HandleConnect(const boost::system::error_code& e,  boost::asio::ip::tcp::resolver::iterator endpoint_iterator)
{
 ...
 void TCPCom::disconnect(){
}


 boost::asio::ip::tcp::socket& TCPCom::GetSocket(){
	return socket_;
}

 void TCPCom::ResolveAddress(boost::asio::io_service& io_service, const std::string& host_ip, const std::string& host_port){
...
//get port
	 unsigned short TCPCom::GetPort(){ 
			return socket_.remote_endpoint().port();
		}

		//get port
	std::string TCPCom::GetAddress(){
